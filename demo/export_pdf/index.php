...
$pdf->SetXY(80, 5  );
$pdf->Cell(20, 5, 'CONCRE', 1 , 1);

$pdf->SetTextColor(253 , 200  , 47);
$pdf->SetXY(100, 5  );
$pdf->Cell(26, 5, 'TOLIMA S.A.', 1 , 1);
//------------------------------------------------------------------------------------------
$pdf->SetFont('Arial','B',11);
$pdf->SetTextColor(0 , 0  , 0);
$pdf->SetFillColor(225, 225, 225);
$pdf->SetXY(55, 10  );
$pdf->Cell(100, 5, 'SUMINISTRO DE CONCRETO', 1 , 1,'C');
//------------------------------------------------------------------------------------------
$pdf->SetFont('Arial','',7);
$pdf->SetFillColor(225, 225, 225);
$pdf->SetXY(55, 17  );
...
$pdf->MultiCell(170, 4, $producto, 0, "", false);
