...
if (isset($_GET['txt_fecha_ini']) && isset($_GET['txt_fecha_fin'])) {
    ...
    $spreadsheet->setActiveSheetIndex(0)
        ...
        ->setCellValue('AT1', 'PLANTAID')
        ->setCellValue('AU1', 'LATITUD')
        ->setCellValue('AV1', 'LONGITUD')
        ->setCellValue('AW1', 'DISTANCIARMI')
        ->setCellValue('AX1', 'DISTANCIARZO')
        ->setCellValue('AY1', 'DISTANCIARMT')
        ->setCellValue('AZ1', 'DISTANCIAHND')
        ->setCellValue('BA1', '');
    ...
    if (is_array($datos)) {
        ...
        foreach ($datos as $fila) {
            ...
            $spreadsheet->setActiveSheetIndex(0)
                ...
                ->setCellValue('AT' . $x, "")
                ->setCellValue('AU' . $x, $latitud)
                ->setCellValue('AV' . $x, $longitud)
                ->setCellValue('AW' . $x, $distanciaRMI)
                ->setCellValue('AX' . $x, $distanciaRZO)
                ->setCellValue('AY' . $x, $distanciaRMT)
                ->setCellValue('AZ' . $x, $distanciaHND)
                ->setCellValue('AB' . $x, "");
