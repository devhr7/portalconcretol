    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div id="contenido">
                    <table id="t_color_concreto" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                <th> N </th>
                                <th> Codigo </th>
...
<script>
    $(document).ready(function() {
        var n = 1;
        var table = $('#t_color_concreto').DataTable({
            //"processing": true,
            //"scrollX": true,
            "ajax": {
                "url": "data_table_color_concreto.php",
                "dataSrc": ""
            },
            "order": [
                [0, 'desc']
        ...
        $('#t_color_concreto tbody').on('click', 'button', function() {
