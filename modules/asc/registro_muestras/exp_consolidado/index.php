...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Exportar CONSOLIDADO BASE DE DATOS REGISTRO DE TOMA DE MUESTRAS ENSAYO A COMPRESIÓN O FLEXIÓN</h1>
                </div>
                <div class="col-sm-6">
                    <!--
    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form id="form-informe" name="form-informe" method="GET" action="excel.php">
                    <div id="contenido">
