...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="card">
          ...
          <div class="card-body">
                <form id="form-informe-remisiones1" name="form-informe-remisiones1" method="GET" action="excel1.php">
                <div id="contenido">
                    
                    
                    <div class="row">
                        <div class="col">
                            <h5>Seleccionar Rango de Fecha Requisiciones con Facturas</h5>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-2">
                            <button class="btn btn-block bg-gradient-success"> <i class="fas fa-file-excel"></i>     Exportar Requisiciones </button>
                        </div>
                    </div>
                </div>
                </form>
