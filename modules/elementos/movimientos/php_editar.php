...
if (isset($_POST['id_movimiento_edit']) && !empty($_POST['id_movimiento_edit'])) {
    $id_movimiento = $_POST['id_movimiento_edit'];
    $fecha = $_POST['fecha_edit'];
    $id_tipo_movimiento = $_POST['txt_tipo_movimiento_edit'];
    $id_empleado = $_POST['id_empleado_edit'];
    ...
    $id_elemento_epp = $_POST['id_epp_edit'];
    $nombre_epp = $elementos->get_descripcion_epp($id_elemento_epp);
    $cantidad = $_POST['cantidad_edit'];
    $observaciones = $_POST['txt_observaciones_edit'];
    if ($elementos->editar_salida_epp($id_movimiento, $fecha, $id_tipo_movimiento, $id_empleado, $nombre_empleado, $id_cargo, $nombre_cargo, $id_area, $nombre_area, $id_elemento_epp, $nombre_epp, $cantidad,$observaciones)) {
        $php_estado = true;
    } else {
