...
while ($fila_remi = $datos_remision->fetch(PDO::FETCH_ASSOC)) {
    ...
    //Bomba
    $ct26_id_bomba = $fila_remi['ct26_id_bomba'];
    $bomba = $fila_remi['ct26_bomba'];
    $id_op_bomba = $fila_remi['ct26_id_op_bomba'];
    $id_aux_bomba = $fila_remi['ct26_id_aux_bomba'];
    $servicio_bomba = $fila_remi['ct26_servicio_bomba'];
    $cant_bomba = $fila_remi['ct26_cant_bomba'];
    
}
$firephp->fb( "HR",FirePHP::LOG);
$firephp->fb( $t26_remisiones->select_bomba_edit($id_remision),FirePHP::LOG);
$firephp->fb( $bomba,FirePHP::LOG);
$firephp->fb( $id_op_bomba,FirePHP::LOG);
$firephp->fb( $id_aux_bomba,FirePHP::LOG);
$firephp->fb( $cant_bomba,FirePHP::LOG);
$firephp->fb( "HR",FirePHP::LOG);
                    ...
                    <form name="form_update" id="form_update" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group clearfix">
                                    <div class="icheck-primary d-inline">
                                        <input type="checkbox" value="1" name="check_habilitar_hremision" id="check_habilitar_hremision" <?php print_r($permisos_hora); ?>>
                            ...
                            <div class="col-md-2">
                                <div class="form-group clearfix">
                                    <div class="icheck-primary d-inline">
                                        <input type="checkbox" value="1" name="check_habilitar_nremision" id="check_habilitar_nremision" <?php print_r($permisos_num_hora); ?>>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group clearfix">
                                    <div class="icheck-primary d-inline">
                                        <input type="checkbox" value="1" name="check_habilitar_cli_obra" id="check_habilitar_cli_obra" <?php print_r($permisos_cli_obra); ?>>
                        ...
                        <div class="row">
                            <div class="col-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="txt_hremi" name="txt_hremi" value="<?php print_r($hora_remi); ?>" disabled="disabled">
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="form-group">
                                    <label for="txt_nremi"> Numero Remision</label>
                                    <input type="text" class="form-control" id="txt_nremi" name="txt_nremi" value="<?php print_r($codigo_remi); ?>" disabled="disabled">
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="form-group">
                                    <label for="txt_cliente">Cliente</label>
                                    <select id="txt_cliente" name="txt_cliente" class="form-control select2" disabled="disabled">
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <select id="txt_obra" name="txt_obra" class="form-control select2" disabled="disabled">
                            ...
                            <div class="col">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <div class="form-group clearfix">
                                            <div class="icheck-primary d-inline">
                                                <input type="checkbox" id="check_hab_mix_cond" name="check_hab_mix_cond" value="1" <?php print_r($permisos_conductor_mix); ?>>
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="txt_vehiculo" name="txt_vehiculo" class="form-control select2" disabled="disabled">
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <select id="txt_conductor" name="txt_conductor" class="form-control select2" disabled="disabled">
                            ...
                            <div class="col">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="form-group clearfix">
                                            <div class="icheck-primary d-inline">
                                                <input type="checkbox" id="check_hab_producto" name="check_hab_producto" value="1" <?php print_r($permisos_producto); ?>>
                                    ...
                                    <div class="col-4">
                                        ...
                                        <div class="form-group clearfix">
                                            <div class="icheck-primary d-inline">
                                                <input type="checkbox" id="check_hab_sello" name="check_hab_sello" value="1" <?php print_r($permisos_sello); ?>>
                                ...
                                <div class="row">
                                    <div class="col-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="txt_m3" name="txt_m3" value="<?php print_r($m3); ?>" disabled="disabled">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for="txt_producto"> Producto</label>
                                            <select id="txt_producto" name="txt_producto" class="form-control select2" disabled="disabled">
                                    ...
                                    <div class="col-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="txt_asentamiento" name="txt_asentamiento" value="<?php print_r($asentamiento); ?>" disabled="disabled">
                                        </div>
                                    </div>
                                    <div class="col-2">
                                        <label for="txt_sello"> Sello de Seguridad</label>
                                        <input type="text" class="form-control" id="txt_sello" name="txt_sello" value="<?php print_r($sello); ?>" disabled="disabled">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col">
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <div class="form-group clearfix">
                                            <div class="icheck-primary d-inline">
                                                <input type="checkbox" id="check_hab_std" name="check_hab_std" value="1" <?php print_r($permisos_std); ?>>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <select id="txt_estado" name="txt_estado" class="form-control select2" disabled="disabled">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="form-group">
                                    <div class="form-group clearfix">
                                        <div class="icheck-primary d-inline">
                                            <input type="checkbox" id="check_habilitar_bomba" name="check_habilitar_bomba" value="1" <?php print_r($permisos_bomba); ?>>
                                            <label for="check_habilitar_bomba">
                                                Habilitar Bombas
                                            </label>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="select_servicio_bomba" id="select_servicio_bomba" disabled="disabled">
                                    <?php  echo $t26_remisiones->select_bomba_edit($id_remision); ?>
                                    </select>
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="form-group">
                                    ...
                                    <select name="select_op_bomba" id="select_op_bomba" class="form-control select2" disabled="disabled">
                            ...
                            <div class="col-3">
                                <div class="form-group">
                                    ...
                                    <select name="select_aux_bomba" id="select_aux_bomba" class="form-control select2 " disabled="disabled">
                            ...
                            <div class="col-3">
                                <div class="form-group">
                                    ...
                                    <label for="select_aux_bomba">Metros Bombeados</label>
                                    <input type="text" name="txt_mtbombeados" id="txt_mtbombeados" class="form-control  " value="<?php echo $cant_bomba ?>" disabled="disabled" />
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="form-group">
                                    <div class="form-group clearfix">
                                        <div class="icheck-primary d-inline">
                                            <input type="checkbox" id="check_habilitar" name="check_habilitar" value="1" <?php print_r($permisos_arch); ?>>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <div class="form-group clearfix">
                                        <div class="icheck-primary d-inline">
                                            <input type="checkbox" value="1" name="check_habilitar_horas" id="check_habilitar_horas" <?php print_r($disabled_horas);  ?> <?php print_r($disabled_horas); ?>>
                        ...
                        <div class="row">
                            ...
                            <div class="col-2">
                                <div class="form-group">
                                    <button type="button" class="btn btn-block bg-gradient-orange" data-toggle="modal" data-target="#modal-anular" <?php echo $permisos_btn ?>> <i class="fas fa-ban"></i>
                                        Anular</button>
                                </div>
                            </div>
                            ...
                            <div class="col-3">
                                <div class="form-group">
                                    <button type="button" class="btn btn-block bg-gradient-danger" data-toggle="modal" data-target="#modal-eliminar" <?php echo $permisos_m3 ?>> <i class="fas fa-trash"></i> Eliminar Remision</button>
                                </div>
                            </div>
...
<script>
    $(document).ready(function() {
        ...
        // check habiliar_obra
        $('#check_habilitar_bomba').click(function() {
            if (!$(this).is(':checked')) {
                $("#select_servicio_bomba").attr('disabled', true);
                $("#select_op_bomba").attr('disabled', true);
                $("#select_aux_bomba").attr('disabled', true);
                $("#txt_mtbombeados").attr('disabled', true);
            } else {
                $("#select_servicio_bomba").attr('disabled', false);
                $("#select_op_bomba").attr('disabled', false);
                $("#select_aux_bomba").attr('disabled', false);
                $("#txt_mtbombeados").attr('disabled', false);
