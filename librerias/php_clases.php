...

{
    ...
    function permisos_habilitar($rol_user, $array_roles)
    ...
    function estado_remi_cli($estado)
...

    {
        ...
        switch ($estado) {
            ...
            case 2:
                ...
                $state = 'Pendiente de Facturacion';
            ...
            case 4:
                ...
                $state = 'Falta Sincronizacion de datos';

                break;

            case 5:

                $state = 'Consumo Interno';
...

    {
        ...
        switch ($estado) {
            ...
            case 10:
                ...
                $state = '<small class="badge badge-danger"> Anulada </small>';
...

    {
        ...
        switch ($estado) {
            ...
            case 2:
                ...
                $state = '<small class="badge badge-warning"> Desabilitado </small>';
